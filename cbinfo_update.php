...
if ($emaildata) {
	...
	if ($email == "") {
		$error = "<p class='error_echo'>Please type your LGBT email!</p>";
	}else if ($email_run >= 1) {
		...
		$error = "<p class='succes_echo'>Email successfully changed.</p>";
						// send email
						$msg = "Successfully your LGBT email has been changed. 
						
						";
						mail($email ,"LGBT Email Changed",$msg, "From:LGBT <no-reply@lgbt.com>");
...
<?php echo $error; ?>
	<ul>
		...
		<li style="float: right;">
			...
			<div class="uiaccountstyle">
				<form action="cbinfo_update.php" method="POST">
				<h2><p>Change LGBT Email</p></h2></br>
					LGBT Email: </br><input type="email" name="email" id="email" class="placeholder" size="43" value="<?php echo $db_email; ?>"> </br></br>
