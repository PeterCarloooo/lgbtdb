...
//check for userfrom propic delete
 ...
 <?php 
	...
	$lgbt = mysql_real_escape_string($post);
...
<head>
	...
	<meta charset="utf-8" />
	<link rel="icon" href="http://www.lgbt.com/img/2.png" type="image/x-icon">
	...
	<div class="pro_body">
		<div class="pro_header">
			<nav class="pro_hdr_menu">
				<ul>
					<li><a href="http://m.lgbt.com/newsfeed.php">Newsfeed</a></li>
					<li><a href="http://m.lgbt.com/profile.php?u=<?php echo "$user"; ?>">Profile</a></li>
					<li><a href="http://m.lgbt.com/messages.php">Message</a></li>
					<li><a href="http://m.lgbt.com/followRequest.php">Friends</a></li>
					<li><a href="http://m.lgbt.com/notification.php">Notification</a></li>
					<li><a href="http://m.lgbt.com/search.php">Search</a></li>
				</ul>
			</nav>
		</div>
		<?php echo $error; ?>
