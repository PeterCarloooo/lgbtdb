...
<head>
    ...
    <!--[if lt IE 9]>
        <script src="FullCalendar/js/html5shiv.js"></script>
        <script src="FullCalendar/js/respond.min.js"></script>
    <![endif]-->
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="newsfeed.php">LGBT Community</a>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1 style="font-weight:bolder; font-size:50px;">EVENT CALENDAR</h1>
				<br>
			...
			<form class="form-horizontal" method="POST" action="addEvent.php">
			  ...
			  <div class="modal-body">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  <input type="text" name="title" class="form-control" id="title" placeholder="Title of Event">
					</div>
				  </div>
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  <select name="color" class="form-control" id="color">
						  ...
						  <option style="color:#FF7F00;" value="#FF7F00">&#9724; Orange</option>
						  ...
						  <option style="color:#9400D3;" value="#9400D3">&#9724; Violet</option>
						</select>
					</div>
				  </div>
				  <div class="form-group">
