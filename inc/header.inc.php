...
$check_for_lgbt_noti = mysql_query("SELECT * FROM lgbt_comments WHERE lgbt_to='$user' AND opened='no' ORDER BY id DESC");
$lgbt_noti_num = mysql_num_rows($check_for_lgbt_noti);
$noti_num = $post_noti_num + $lgbt_noti_num;
...
if (isset($_POST['gotonoti'])) {
	if ($post_noti_num > $lgbt_noti_num) {
	     header("location: notification.php");
	}else {
	     header("location: notifications.php");
	     }
	$pstopened_query = mysql_query("UPDATE post_comments SET opened='yes' WHERE posted_to='$user'");
	$lgbtopened_query = mysql_query("UPDATE lgbt_comments SET opened='yes' WHERE lgbt_to='$user'");
...
<div class="header">
	<div class="headerMainmenu">
		<div>
			...
			<?php
			if ($user != '') {
				echo '<li class="logo"><a href="newsfeed.php" title="Go to LGBT Home" >LGBT</a></li>
				<li class="search" style="float: left;">
					<form action="search.php" method="get">
						...
						<button type="submit" name="search" ><img src="./img/search.png" style="margin: 0 0 -12px 25px; float: right; padding: 0;" height="35" width="35"></button>
					</form>
				</li>
...
"><a href="logout.php" title="Log me out" style="font-weight: bold; margin: 3px 8px; font-size: 14px; color: #0B810B;">Logout</a>
						...
						if ($unread_numrows == "") {
							...
							<img src="./img/msg.png" style="margin: 6px;" height="40" width="35">
							</button>
							</form>
							</li>';
						}else {
							...
							<img src="./img/msg.png" style="margin: -13px;" height="40" width="35">'.$unread_msg_numrows.'</a>
							</button>
							</form>
							</li>';
						}
						...
						if ($follow_numrows == "") {
							...
							<img src="./img/follow.png" style="margin: 11px 2px 11px 11px;" height="27" width="28">
							</button>
							</form>
							</li>';
						}else {
							...
							<img src="./img/follow.png" style="margin: -4px;" height="27" width="28">'.$unread_follow_numrows.'</a>
							</button>
							</form>
							</li>';
						}
					...
					<li><a href="newsfeed.php" style=" margin: 17px 0px 17px 17px;" title="Go to newsfeed"><img src="./img/home.png" style="margin:-5px; padding: 0 5px;" height="27" width="30"></a></li>
				</div>';
			}else {
				echo '<li class="logo"><a href="newsfeed.php" title="Go to LGBT Home" >LGBT</a></li>
