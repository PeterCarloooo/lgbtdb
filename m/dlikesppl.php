...
if (isset($_REQUEST['dlikep'])) {
	$getid = $_REQUEST['dlikep'];
}else {
...
<div class="pro_body">
	...
	<div style="width: 100%;">
		...
		<h2 style='font-size: 20px';>LGBT Like</h2><br />
			<?php 
			$user_from = "";
			//grab the message for the logged in user
			$grab_post = mysql_query("SELECT * FROM lgbt_likes WHERE lgbt_id='$getid' ORDER BY id DESC");
