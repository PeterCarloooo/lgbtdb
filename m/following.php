				...
				echo '<div>
					     <table class="friendsmenu">
							<tr>
								...
								<th style="background-color: #686B68;"><a href="following.php?u='.$username.'" ><h1>Following </br>'.$countfollowing.'</h1></a></th>
								<th><a href="followers.php?u='.$username.'"><h1>Followers </br>'.$countfollowers.'</h1></a></th>
							</tr>
						</table>
					</div>';
					if ($countfollowing == 0){
						echo '<div class="search_banner"><p style="font-size: 15px; margin: 10px; font-weight: bold; color: #7B7B7B;">No following found!<br></p>
						</div>';
					}else {
