...
if (isset($_POST['newlgbt'])) {
	header("location: composelgbt.php");
}
	...
	<div class="pro_body">
		<div class="pro_header">
			<nav class="pro_hdr_menu">
				<ul>
					...
					<li ><a href="index.php" style="color: #2AED25; font-weight: bold;">LGBT Community</a></li>	
		...
		<div class="post_field">
				<div class="profilePosts">
					<div class="postForm">
						<form action="" method="POST">
							...
							<div style="float: right;">
								<input type="submit" name="newlgbt" value="New lgbt" class="postSubmit" >
							</div>
					...
					$lastid = "";
					$getposts = mysql_query("SELECT * FROM posts WHERE lgbt_give != '0' ORDER BY id DESC LIMIT 10") or die(mysql_error());
					if (mysql_num_rows($getposts)) {
					echo '<ul id="recs">';
					while ($row = mysql_fetch_assoc($getposts)) {
						include ( "./inc/getlgbtpost.inc.php" );
						$lastid = $row['id'];
					}
