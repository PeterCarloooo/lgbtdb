						...
						if (mysql_num_rows($check)===1) {
							...
							if ($pro_nums != 0) {
								...
								if ($pro_changed_dbs != $profile_pic_dbs) {
									$profile_pics = "http://www.lgbt.com/img/default_propic.png";
								}else {
									$profile_pics = 'http://www.lgbt.com/userdata/profile_pics/'.$profile_pic_dbs.'';
								}
							}else {
								$profile_pics = "http://www.lgbt.com/img/default_propic.png";
							}
							...
							if ($username != $user) {
								...
								$conn = new PDO("mysql:host=localhost;dbname=lgbtco_td","lgbtco_td","sinEmi4334222");
