...
if (isset($_REQUEST['pid'])) {
	...
	$sharelgbtid = $post_info['lgbt_post'];
...
if (isset($_POST['continue']) and ! empty($_POST['continue'])) {
    if (isset($_POST['action_key'])) {
        ...
        }else if($radio_input == "lgbt_POST") {
        	$_SESSION['lgbtid'] = $id;
		
		if($sharelgbtid != 0) {
			$_SESSION['lgbtid'] = $sp_id;
			header("location: sharepost.php?did=$sharelgbtid");
		}else {
									...
									<div class="v">
										<table class="c">
											<tbody>
												<tr>
													<td class="radio">
														<input name="action_key" value="lgbt_POST" type="radio"></input>
													</td>
													<td>
														<div class="v">
															<div>
																<span class="c_b">Add to lgbt</span>
															</div>
															<div>
																<span class="c_g">This post show in lgbt timeline.</span>
															</div>
														</div>
													</td>
												</tr>
