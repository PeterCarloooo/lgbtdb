			...
			if ($num == 1) {
				...
				<div id="top">
					...
					if (($msg_count >=1 ) || ($username == $user)){
						...
						$getposts = mysql_query("SELECT * FROM posts WHERE user_posted_to ='$username' AND note='0' AND lgbt_give='0' AND report='0' ORDER BY id DESC LIMIT 10") or die(mysql_error());
