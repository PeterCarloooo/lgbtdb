...
<div class="main">
	...
	<ul class="userinfo">
		...
		?>
		<form class="bg" method="POST" action="editUsers.php?user=<?php echo $id; ?>" enctype="multipart/form-data" style="padding: 22px;">
			<div>
			...
			<div style="margin-left: 370px;">
				...
				<h1 style="font-weight:bolder; margin-left:10%; font-size:35px; font-family:century;">User Profile</h1><br>
				<h1>--------------------------------------------------------------------------</h1>
				<br>
					<tr>
						<td>Id:</td>
					...
					<tr>
						<td></td>
						<td align="center"><input type="submit" name="updateinfo" style="cursor: pointer; width: 105px; background-color: #CC8D52; color: #FFF; font-weight: bold;" placeholder="Change Data" /></td>
					</tr>
				</table>
			</div>
		</form>
