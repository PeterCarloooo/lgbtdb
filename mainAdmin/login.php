<?php 
	...
	if (isset($_POST['login'])) {
		if (isset($_POST['admin_user']) && isset($_POST['admin_pass'])) {
			...
			$num = 0;
			$password_login = ($admin_pass);
			$result = mysql_query("SELECT * FROM admin_login WHERE user_name='$admin_user' AND user_pass='$password_login'");
...
<form method="POST" action="login.php" style="padding: 84px 15px;">
	<table class="admintable" width="35%" align="center" bgcolor="orange" style="margin-left:33%; margin-top:5%;">
		<tr>
