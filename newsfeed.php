...
<html>
<head>
	<title>Newsfeed • LGBT Community</title>
	<link rel="icon" href="./img/2.png" type="image/x-icon">
	<link rel="stylesheet" type="text/css" href="./css/header.css">
	<script>
		if(/Android|webOS|iPhone|iPad|iPod|BlackBerry/IEMobile/i.test(navigator.userAgent)){
		if(document.URL !="http://m.LGBT.com")
		{
		window.location ="http://m.LGBT.com";
		}
		}
	</script>
	<style type="text/css">
...
<table>
	<tbody>
					...
					<div class="home_cov" style= "background: url(<?php echo $cover_pic; ?>) repeat center center;">
						...
						<div class="homenavemanu">
							<div >
								...
								<div ><a href="event.php">Event</a></div>
								<div ><a href="groupchat.php">Group Chat</a></div>
							</div>
						</div>
					</div>
				</div>
		...
		$getposts = mysql_query("SELECT * FROM posts WHERE newsfeedshow ='1' AND report ='0' AND note='0' AND LGBT_give='0' ORDER BY id DESC") or die(mysql_error());
