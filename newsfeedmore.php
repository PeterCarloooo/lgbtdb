...
if (!isset($_SESSION['user_login'])) {
 ...
 if ($newsfeedlastid >= 1) {
		...
		$getposts = mysql_query("SELECT * FROM posts WHERE newsfeedshow ='1' AND report ='0' AND note='0' AND LGBT_give='0' AND id < $newsfeedlastid ORDER BY id DESC") or die(mysql_error());
