		...
		if (isset($_POST['user_login']) && isset($_POST['password_login'])) {
			...
			if ($num>0) {
				...
				if ($num1>0) {
					...
					$success_message = '
						<div class="exp"><div class="maincontent_text" style="text-align: center;">
						...
						<form action="signin.php" method="POST">
							...
							<input class="submRecov" type="submit" name="submconfrmCode" id="senddata" value="Continue lgbt">
						</form>
						</div></div>
						';
			...
			if ($check == 0 ) {
				if ($email_check == 0) {
					if (strlen($_POST['password']) >4 ) {
						...
						";
						//if (@mail($_POST['email'],"lgbt Activation Code",$msg, "From:lgbt <no-reply@lgbt.com>")) {
						...
						//success message
						$success_message = '
						<div class="exp"><h2><font face="bookman">Registration Successfull!</font></h2>
						<div class="maincontent_text" style="text-align: center;">
						<font face="bookman">
							Email: '.$u_email.'<br>
							Username: '.$_POST['username'].'
...
//getting lgbt post photo
$getposts = mysql_query("SELECT * FROM lgbt WHERE photos != '' ORDER BY  RAND() ");
$row = mysql_fetch_assoc($getposts);
$photos_db = $row['photos'];
$photosrow = "./userdata/lgbt_pics/".$photos_db;
...
<html>
	<head>
	<title>LGBT Community</title>
	<meta charset="uft-8">
	<link rel="icon" href="./img/2.png" type="image/x-icon">
	<link rel="image_src" href="http://www.lgbt.com/userdata/lgbt_pics/nur/1453542261.jpg" /><!--formatted-->
	<link rel="stylesheet" type="text/css" href="./css/style.css">
	<meta name="description" content="Peace Upon You. Join to lgbt Community. Connect with your family. lgbt Community. Get update over the world." /><!--formatted-->
	    <meta name="viewport" content="width=device-width, initial-scale=1.0">
	    <script type="text/javascript">
		  <!--
		  if (screen.width <= 800) {
		    window.location = "http://m.lgbt.com/login.php";
		  }
		  //-->
		</script>
	...
	<body style= "background: url(<?php echo $photosrow; ?>) no-repeat center center; background-size: 100%; ">
		<div class="main">
			<div class="headerLogin" style="background-color:orange;">
				<div class="login_menubar clearfix" >
					<div class="menu_logo">
						<h1>
							<a title="Go to LGBT Home" href="index.php">
								<b>LGBT Community</b>
							</a>
						</h1>
					</div>
						...
						<form action="" method="POST">
							<table class="menu_login_container">
								...
								<tr class="login_">
									...
									<td>
										<input type="submit" name="login" class="uiloginbutton" value="LOGIN">
									</td>
								</tr>
								<tr>
									<td class="">
										<label>
											<div>
												...
												<div class="uiInputLabelLabel" style="color:#fff;">Keep me logged in</div>
											</div>
										</label>
									</td>
									<td class="login_form_label_field">
										<a href="passRecover.php" style="text-decoration:none; color:#fff"</a>
									</td>
								</tr>
							</table>
						</form>
				...
				<div class="container">
					<div>
						...
						<div class="maincontent">
							...
							<div class="signupform_content" style="width:41%; margin-right:30%;">
							<br>
								<h2 style="color:white; font-family:bebas; font-size:50px;">SIGN UP</h2><br>
								<div class="signupform_text"></div>
								<div>
									<form action="" method="POST" class="registration">
										<div class="signup_form" style="background-color:orange;">
											<div>
												<td >
											...
											<div>
												<td>
													<input  style="width:94%;" name="password" id="password-1" required="required" style="overflow: hidden; padding-right: 7px;" placeholder="Enter New Password" class="password signupbox passbox_wihei" type="password" size="30" value="">
												</td>
											</div>
											<br>
												<div>
												<h1 style="text-align:left; font-weight:bolder; font-size:20px; margin-left:60px;">SEX</h1>
												</div>
											<div class="gender">
												<td>
													<th>
											...
											<div>
												<input name="signup" class="uisignupbutton signupbutton" type="submit" value="Sign Up" style="font-family:bebas;">
											</div>
